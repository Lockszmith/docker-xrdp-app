#### A fork of the docker-calibre from the [LinuxServer.io](https://linuxserver.io) team. Each branch of this repo hosts a different application.
===========================================================================
# Original README.md content from [linuxserver/docker-calibre](https://github.com/linuxserver/docker-calibre):
